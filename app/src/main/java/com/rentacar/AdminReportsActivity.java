...
public class AdminReportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv=(ListView)findViewById(R.id.listgetadminbookings);
    ...
    public  void getrecords() {
        ...
        String url = "http://possakrishna.com/Rentacar/getadmincars.php";
...
// Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(AdminReportsActivity.this,"No Internet",Toast.LENGTH_LONG).show();
            }
        });
// Add the request to the RequestQueue.
    ...
    private void parseServerJsonData(String response) {//Step -2
        ...
        try {
            ...
            lv.setAdapter(new AdminReportsActivity.CustomAdapter(this, student_info));//Step -4
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.idlogout:
                ...
                Intent i=new Intent(AdminReportsActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
