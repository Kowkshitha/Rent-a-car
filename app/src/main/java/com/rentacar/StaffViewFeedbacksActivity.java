...
public class StaffViewFeedbacksActivity extends AppCompatActivity {

    ListView lv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_view_feedbacks);
        lv=(ListView)findViewById(R.id.listgetfeedbacks);
...
// Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(StaffViewFeedbacksActivity.this,"No Internet",Toast.LENGTH_LONG).show();
            }
        });
// Add the request to the RequestQueue.
    ...
    private void parseServerJsonData(String response) {//Step -2
        ...
        try {
            ...
            lv.setAdapter(new StaffViewFeedbacksActivity.CustomAdapter(this, student_info));//Step -4
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.idlogout:
                ...
                Intent i=new Intent(StaffViewFeedbacksActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
