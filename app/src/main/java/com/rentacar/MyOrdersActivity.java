...
public class MyOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv=(ListView)findViewById(R.id.listgetmybookings);
    ...
    public  void getrecords() {
        ...
        String url = "http://possakrishna.com/Rentacar/getmybookings.php";
...
// Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MyOrdersActivity.this,"No Internet",Toast.LENGTH_LONG).show();
            }
        })
        {
            @Override
            protected Map<String, String> getParams() {
                sharedPreferences = MyOrdersActivity.this.getSharedPreferences("customer", Context.MODE_PRIVATE);
...
// Add the request to the RequestQueue.
    ...
    private void parseServerJsonData(String response) {//Step -2
        ...
        try {
            ...
            lv.setAdapter(new MyOrdersActivity.CustomAdapter(this, student_info));//Step -4
...
//            bt.setTag(hm.get("RequestId").toString());
            ...
            imgnext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.putExtra("Id", tv1.getTag().toString());
                    i.putExtra("cid", tv2.getTag().toString());
                    i.putExtra("plate", tv3.getTag().toString());
                    i.putExtra("user", tv4.getTag().toString());
                    i.putExtra("amount", tv8.getTag().toString());
                    i.putExtra("dat", tv5.getTag().toString());
                    i.putExtra("fdate", tv6.getTag().toString());
                    i.putExtra("status", btn.getTag().toString());
                    i.putExtra("tdate", tv7.getTag().toString());
