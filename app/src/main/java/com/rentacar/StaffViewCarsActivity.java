...
public class StaffViewCarsActivity extends AppCompatActivity {
    AlertDialog.Builder builder;
    ListView lv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_view_cars);
...
// Request a string response from the provided URL.
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(StaffViewCarsActivity.this,"No Internet",Toast.LENGTH_LONG).show();
            }
        });
// Add the request to the RequestQueue.
    ...
    private void parseServerJsonData(String response) {//Step -2
        ...
        try {
            ...
            lv.setAdapter(new StaffViewCarsActivity.CustomAdapter(this, student_info));//Step -4
...
//            tv5.setVisibility(View.GONE);
            ...
            Imgedit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(StaffViewCarsActivity.this,UpdateCarsActivity.class);
            ...
            builder = new AlertDialog.Builder(StaffViewCarsActivity.this);
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface arg0, int arg1) {
                    Toast.makeText(StaffViewCarsActivity.this,"Deletion Cancelled",Toast.LENGTH_LONG).show();
                }
            });
...
//            bt.setTag(hm.get("RequestId").toString());
            ...
            imgnext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(StaffViewCarsActivity.this,CarDetailsActivity.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equalsIgnoreCase("success")) {
                            ...
                            Toast.makeText(StaffViewCarsActivity.this,"Deleted Successffuly",Toast.LENGTH_LONG).show();
                            Intent i=new Intent(StaffViewCarsActivity.this,StaffViewCarsActivity.class);

                            startActivity(i);
                        }
                        else
                        {
                            Toast.makeText(StaffViewCarsActivity.this,"Deletion Failed",Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.idlogout:
                ...
                Intent i=new Intent(StaffViewCarsActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
